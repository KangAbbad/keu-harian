...
<!-- jQuery 3 -->
<?= $this->tag->stylesheetLink('assets//bower_components/jquery/dist/jquery.min.js') ?>
<!-- Bootstrap 3.3.7 -->
<?= $this->tag->stylesheetLink('assets/bower_components/bootstrap/dist/js/bootstrap.min.js') ?>
<!-- iCheck -->
<?= $this->tag->stylesheetLink('assets/plugins/iCheck/icheck.min.js') ?>
<script>
  $(function () {
    $('input').iCheck({
