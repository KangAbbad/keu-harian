...
<!-- jQuery 3 -->
{{ stylesheet_link("assets//bower_components/jquery/dist/jquery.min.js") }}
<!-- Bootstrap 3.3.7 -->
{{ stylesheet_link("assets/bower_components/bootstrap/dist/js/bootstrap.min.js") }}
<!-- iCheck -->
{{ stylesheet_link("assets/plugins/iCheck/icheck.min.js") }}
<script>
  $(function () {
    $('input').iCheck({
